...
### 🖼️ IMAGEN
![Post 2026-04-21](content/images/post-2026-04-21.png)
> Archivo: `content/images/post-2026-04-21.png`
> Descárgala desde GitHub para subirla a Instagram

### 📸 POST — Caption completo
```
🤖✨ TIP DE IA PARA HOY: Usa ChatGPT como tu asistente de correos profesionales en segundos.

¿Cuánto tiempo pierdes redactando emails difíciles? 😩 Aquí te va el truco:

📋 PROMPT QUE PUEDES COPIAR AHORA:
"Actúa como un comunicador profesional. Escríbeme un correo [formal/amable/firme] dirigido a [persona/cargo] sobre [tema]. El tono debe ser [seguro/empático/directo]. Máximo 150 palabras."

💡 EJEMPLOS DE USO REAL:
✅ Pedir un aumento de sueldo
✅ Rechazar una propuesta sin quedar mal
✅ Hacer seguimiento a un cliente sin sonar desesperado
✅ Dar feedback negativo con tacto

⚡ PRO TIP: Agrega al final del prompt → "Incluye un asunto llamativo para el correo" y ChatGPT te lo da todo listo.

🎯 Pruébalo HOY y cuéntame en comentarios cuánto tiempo te ahorró. ¡Vas a alucinar con los resultados! 🚀

#InteligenciaArtificial #ChatGPT #TipsDeIA #ProductividadDigital #IAenEspañol #TecnologíaLatam #AutomatizaciónIA #HerramientasIA #TrabajaSmart #IAParaTodos
```


### 📱 STORY — 3 líneas
```
¿Odias escribir correos difíciles?
...
```
¿Sabías que la forma en que le hablás a la IA cambia TODO? 🤯
El 90% de las personas usa ChatGPT o cualquier IA de forma básica y después se quejan de que 'no funciona bien'. El problema no es la herramienta… es el prompt. 🎯
Acá van 3 tips para mejorar tus prompts HOY MISMO:
✅ 1. Dale contexto — No digas 'escribí un post'. Decí: 'Soy diseñador gráfico, escribí un post para Instagram dirigido a emprendedores latinos sobre mis servicios de branding.'
✅ 2. Asignale un rol — Empezá con: 'Actuá como un experto en marketing digital con 10 años de experiencia…' La IA se adapta y mejora exponencialmente.
✅ 3. Pedile que pregunte antes de responder — Escribí: 'Antes de responder, haceme las preguntas necesarias para darte el mejor resultado.' Esto es un cambio de juego. 🔥
Con estas técnicas vas a notar la diferencia desde el primer mensaje. 💡
Y si querés llevar tu prompting a otro nivel con metodología real, tenemos algo muy concreto para vos 👇 (info en stories)
¿Cuál de estos tips ya usabas? Contame en los comentarios 👇
#InteligenciaArtificial #PromptEngineering #TipsDeIA #ChatGPT #IAenEspañol #ProductividadDigital #EmprendedoresLatinos #MarketingDigital #AprendeIA #HerramientasIA #IAparaNegocios #TransformaciónDigital #IALatam
```

### 📱 STORY
```
¿Tu IA te da respuestas mediocres? 😤
El problema está en CÓMO le preguntás 🧠
Aprendé Prompting con ingenieros de la UBA 👉 https://go.hotmart.com/H105480649O
🔗 https://go.hotmart.com/H105480649O
```
